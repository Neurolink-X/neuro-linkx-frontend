        ...
        >
          ...
          <div className='text-center'>
            ...
            >
              ...
              <Code2 className='w-24 h-24 text-yellow-600 animate-float' />
            </motion.div>
            <motion.h1 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5, delay: 0.2 }}
              className='text-6xl font-bold text-[#1e2942] mb-8 bg-clip-text text-transparent bg-gradient-to-r from-[#1e2942] to-yellow-600 max-sm:text-4xl'
            >
