    ...
    <footer className="bg-slate-900 py-20 px-4 relative">
      <div className="container mx-auto">
            ...
            <div className="flex gap-4 text-slate-400">
              ...
              >
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <path d="M279.14 288l14.22-92.66h-88.91V135.4c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S265.43 0 225.36 0c-73.19 0-121.04 44.38-121.04 124.72V195.3H22.89V288h81.43v224h100.17V288z"></path>
                </svg>
              </a>
            </div>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-slate-800 text-center text-slate-400">
          <p>&copy; 2025 NeuroLink. All rights reserved.</p>
        </div>
      </div>
